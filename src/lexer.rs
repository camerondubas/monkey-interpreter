...
mod test {
    ...
    fn test_next_token() {
        ...
        let tokens = vec![
            Token::Let,
            Token::Indentifier(String::from("five")),
            Token::Assign,
            Token::Integer(String::from("5")),
            Token::Semicolon,
            Token::Let,
            Token::Indentifier(String::from("ten")),
            Token::Assign,
            Token::Integer(String::from("10")),
            Token::Semicolon,
            Token::Let,
            Token::Indentifier(String::from("add")),
            Token::Assign,
            Token::Function,
            Token::LeftParen,
            Token::Indentifier(String::from("x")),
            Token::Comma,
            Token::Indentifier(String::from("y")),
            Token::RightParen,
            Token::LeftBrace,
            Token::Indentifier(String::from("x")),
            Token::Plus,
            ...
            Token::Semicolon,
            Token::Let,
            Token::Indentifier(String::from("result")),
            Token::Assign,
            Token::Indentifier(String::from("add")),
            Token::LeftParen,
            Token::Indentifier(String::from("five")),
